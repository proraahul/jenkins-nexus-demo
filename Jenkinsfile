pipeline {
    ...
    stages {
        //stage('Checkout code') {
            //steps {
                //checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[url: 'https://github.com/proraahul/jenkins-nexus-demo']])
           // }
       // }
      //github repo link of the location where your code exist which one you want to convert into artifact and upload to nexus repository
